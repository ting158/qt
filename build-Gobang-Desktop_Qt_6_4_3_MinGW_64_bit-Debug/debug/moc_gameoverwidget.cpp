...
#include <memory>
#include "../../Gobang/gameoverwidget.h"
...
Q_CONSTINIT static const qt_meta_stringdata_GameOverWidget_t qt_meta_stringdata_GameOverWidget = {
    {
        ...
        QT_MOC_LITERAL(15, 12),  // "SandGameOver"
        QT_MOC_LITERAL(28, 0)   // ""
    },
    "GameOverWidget",
    "SandGameOver",
...
void GameOverWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameOverWidget::SandGameOver; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameOverWidget::SandGameOver()
{
